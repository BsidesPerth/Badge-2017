...
{ 0x00, 0x38, 0x00, 0x7C, 0x00, 0xC6, 0x01, 0x82, 0x03, 0x02, 0x03, 0x30, 0x03, 0x30, 0x01, 0x00,
0x01, 0x80, 0x0C, 0xC0, 0x4C, 0xC0, 0x40, 0x80, 0x41, 0x00, 0x23, 0x00, 0x1E, 0x00, 0x08, 0x00 };
...
void setupOLED()   {
  ...
  display.drawBitmap(64, 64,  logo16_glcd_bmp, 16, 16, 1);
  display.display();
  delay(1);
